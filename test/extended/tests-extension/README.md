...
./test/extended/tests-extension/bin/openshift-apiserver-tests-ext list suites

# List tests in a suite
./test/extended/tests-extension/bin/openshift-apiserver-tests-ext list tests --suite=openshift/openshift-apiserver/all

# Show suite info with qualifiers (filtering logic)
./test/extended/tests-extension/bin/openshift-apiserver-tests-ext info | jq '.suites'

# Count tests in a suite
./test/extended/tests-extension/bin/openshift-apiserver-tests-ext list tests --suite=<suite-name> | jq 'length'

# Extract just test names
./test/extended/tests-extension/bin/openshift-apiserver-tests-ext list tests --suite=<suite-name> | jq -r '.[] | .name'
```
...
| Suite Name | Purpose |
|------------|---------|
| `openshift/openshift-apiserver/conformance/parallel` | Fast, parallel-safe tests |
| `openshift/openshift-apiserver/conformance/serial` | Serial execution tests |
| `openshift/openshift-apiserver/optional/slow` | Long-running and timeout tests |
| `openshift/openshift-apiserver/all` | All tests |
...
require (
    github.com/onsi/ginkgo/v2 v2.23.4        // Test framework
    github.com/onsi/gomega v1.38.0           // Assertion library
