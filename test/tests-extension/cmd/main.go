/*
This command is used to run the OpenShift API Server tests extension for OpenShift.
It registers the OpenShift API Server tests with the OpenShift Tests Extension framework
...
import (
	...
	// The import below is necessary to ensure that the openshift-apiserver tests are registered with the extension.
	_ "github.com/openshift/openshift-apiserver/test/tests-extension/test"
)
...
func main() {
	...
	root := &cobra.Command{
		Long: "OpenShift API Server Tests Extension",
	}
