...
replace (
	...
	k8s.io/apimachinery => github.com/dgrisonnet/kubernetes-apimachinery v0.0.0-20231020165502-8297cd7c70e7
	k8s.io/apiserver => github.com/dgrisonnet/kubernetes-apiserver v0.0.0-20231024150639-762993c109c5
