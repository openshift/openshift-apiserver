...
replace (
	...
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20231102175234-ca80b99425ce
	...
	k8s.io/kubernetes => github.com/openshift/kubernetes v0.0.0-20231102175116-581754d3dad2
