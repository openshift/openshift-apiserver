...
replace (
	...
	// Pin to v0.5.0 because v0.6.0 removed SplitHostname() which is still used by
	// the deprecated wrapper in github.com/docker/distribution@v2.8.3/reference/reference_deprecated.go
