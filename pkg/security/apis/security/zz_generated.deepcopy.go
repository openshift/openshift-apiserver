...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RunAsGroupIDRange) DeepCopyInto(out *RunAsGroupIDRange) {
	*out = *in
	if in.Min != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RunAsGroupIDRange.
func (in *RunAsGroupIDRange) DeepCopy() *RunAsGroupIDRange {
	if in == nil {
		return nil
	}
	out := new(RunAsGroupIDRange)
	in.DeepCopyInto(out)
	return out
}
...
func (in *RunAsGroupStrategyOptions) DeepCopyInto(out *RunAsGroupStrategyOptions) {
	*out = *in
	...
	if in.GIDRangeMin != nil {
		in, out := &in.GIDRangeMin, &out.GIDRangeMin
		*out = new(int64)
		**out = **in
	}
	if in.GIDRangeMax != nil {
		in, out := &in.GIDRangeMax, &out.GIDRangeMax
		*out = new(int64)
		**out = **in
	}
	if in.Ranges != nil {
		in, out := &in.Ranges, &out.Ranges
		*out = make([]RunAsGroupIDRange, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
