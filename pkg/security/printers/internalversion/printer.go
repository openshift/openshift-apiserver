...
func printRangeAllocation(allocation *securityapi.RangeAllocation, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printRangeAllocationList(allocationList *securityapi.RangeAllocationList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printSecurityContextConstraint(scc *securityapi.SecurityContextConstraints, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printSecurityContextConstraintList(sccList *securityapi.SecurityContextConstraintsList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
