...
func TestPrintersWithDeepCopy(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			printer: func() ([]metav1.TableRow, error) {
				return printRangeAllocation(&security.RangeAllocation{}, kprinters.GenerateOptions{})
			},
		},
		{
			name: "SecurityContextConstraints",
			printer: func() ([]metav1.TableRow, error) {
				return printSecurityContextConstraint(&security.SecurityContextConstraints{}, kprinters.GenerateOptions{})
			},
		},
	}
