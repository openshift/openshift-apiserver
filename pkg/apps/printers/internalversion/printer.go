...
func printDeploymentConfig(dc *appsapi.DeploymentConfig, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printDeploymentConfigList(list *appsapi.DeploymentConfigList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
