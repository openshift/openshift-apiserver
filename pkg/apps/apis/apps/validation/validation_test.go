...
func TestValidateDeploymentConfigICTMissingImage(t *testing.T) {
	dc := &appsapi.DeploymentConfig{
		...
		Spec: appsapi.DeploymentConfigSpec{
			Replicas: 1,
			Triggers: []appsapi.DeploymentTriggerPolicy{appstest.OkImageChangeTrigger()},
			Selector: appstest.OkSelector(),
			Strategy: appstest.OkStrategy(),
			Template: appstest.OkPodTemplateMissingImage("container1"),
		},
	}
	...
	errorCases := map[string]struct {
		...
		"empty container field": {
			appsapi.DeploymentConfig{
				...
				Spec: appsapi.DeploymentConfigSpec{
					Replicas: 1,
					Triggers: []appsapi.DeploymentTriggerPolicy{appstest.OkConfigChangeTrigger()},
					Selector: appstest.OkSelector(),
					Strategy: appstest.OkStrategy(),
					Template: appstest.OkPodTemplateMissingImage("container1"),
				},
		...
		"missing strategy.type": {
			appsapi.DeploymentConfig{
				...
				Spec: appsapi.DeploymentConfigSpec{
					...
					Selector: appstest.OkSelector(),
					Strategy: appsapi.DeploymentStrategy{
						CustomParams:          appstest.OkCustomParams(),
						ActiveDeadlineSeconds: mkint64p(3600),
					},
					Template: appstest.OkPodTemplate(),
				},
