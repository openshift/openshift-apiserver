...
func autoConvert_v1_RouteList_To_route_RouteList(in *v1.RouteList, out *route.RouteList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]route.Route, len(*in))
		for i := range *in {
			if err := Convert_v1_Route_To_route_Route(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_route_RouteList_To_v1_RouteList(in *route.RouteList, out *v1.RouteList, s conversion.Scope) error {
	...
	if in.Items != nil {
		...
		*out = make([]v1.Route, len(*in))
		for i := range *in {
			if err := Convert_route_Route_To_v1_Route(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
func autoConvert_v1_RouteSpec_To_route_RouteSpec(in *v1.RouteSpec, out *route.RouteSpec, s conversion.Scope) error {
	...
	out.WildcardPolicy = route.WildcardPolicyType(in.WildcardPolicy)
	// WARNING: in.HTTPSetHeaders requires manual conversion: does not exist in peer-type
	// WARNING: in.HTTPDeleteHeaders requires manual conversion: does not exist in peer-type
	return nil
}
