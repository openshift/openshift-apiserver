...
func (s *REST) Delete(ctx context.Context, name string, objectFunc rest.ValidateObjectFunc, _ *metav1.DeleteOptions) (runtime.Object, bool, error) {
	return &metav1.Status{Status: metav1.StatusSuccess}, false, s.client.Delete(ctx, name, metav1.DeleteOptions{})
}
