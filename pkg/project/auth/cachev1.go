...
type AuthorizationCacheV1 struct {
...
func (ac *AuthorizationCacheV1) Run(period time.Duration) {
	ac.skip = &statelessSkipSynchronizer{}

	go utilwait.Forever(func() { ac.synchronize() }, period)
}

func (ac *AuthorizationCacheV1) AddWatcher(watcher CacheWatcher) {
	ac.watcherLock.Lock()
...
func (ac *AuthorizationCacheV1) RemoveWatcher(watcher CacheWatcher) {
	ac.watcherLock.Lock()
	defer ac.watcherLock.Unlock()
...
func (ac *AuthorizationCacheV1) GetClusterRoleLister() SyncedClusterRoleLister {
...
func (ac *AuthorizationCacheV1) synchronizeNamespaces(userSubjectRecordStore cache.Store, groupSubjectRecordStore cache.Store, reviewRecordStore cache.Store) sets.String {
...
func (ac *AuthorizationCacheV1) synchronizePolicies(userSubjectRecordStore cache.Store, groupSubjectRecordStore cache.Store, reviewRecordStore cache.Store) {
...
func (ac *AuthorizationCacheV1) synchronizeRoleBindings(userSubjectRecordStore cache.Store, groupSubjectRecordStore cache.Store, reviewRecordStore cache.Store) {
...
func (ac *AuthorizationCacheV1) purgeDeletedNamespaces(oldNamespaces, newNamespaces sets.String, userSubjectRecordStore cache.Store, groupSubjectRecordStore cache.Store, reviewRecordStore cache.Store) {
...
func (ac *AuthorizationCacheV1) invalidateCache() bool {
...
func (ac *AuthorizationCacheV1) synchronize() {
...
func (ac *AuthorizationCacheV1) syncRequest(request *reviewRequest, userSubjectRecordStore cache.Store, groupSubjectRecordStore cache.Store, reviewRecordStore cache.Store) error {
...
func (ac *AuthorizationCacheV1) List(userInfo user.Info, selector labels.Selector) (*corev1.NamespaceList, error) {
	keys := sets.String{}
...
func (ac *AuthorizationCacheV1) ReadyForAccess() bool {
...
func (ac *AuthorizationCacheV1) notifyWatchers(namespace string, exists *reviewRecord, users, groups sets.String) {
	ac.watcherLock.Lock()
	defer ac.watcherLock.Unlock()
