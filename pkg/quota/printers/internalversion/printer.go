...
func printClusterResourceQuota(clusterResourceQuota *quotaapi.ClusterResourceQuota, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printClusterResourceQuotaList(clusterResourceQuotaList *quotaapi.ClusterResourceQuotaList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printAppliedClusterResourceQuota(appliedClusterResourceQuota *quotaapi.AppliedClusterResourceQuota, _ kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printAppliedClusterResourceQuotaList(appliedClusterResourceQuotaList *quotaapi.AppliedClusterResourceQuotaList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
