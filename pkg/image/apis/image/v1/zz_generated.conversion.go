...
func RegisterConversions(s *runtime.Scheme) error {
	if err := s.AddGeneratedConversionFunc((*v1.DockerImageReference)(nil), (*image.DockerImageReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_DockerImageReference_To_image_DockerImageReference(a.(*v1.DockerImageReference), b.(*image.DockerImageReference), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*image.DockerImageReference)(nil), (*v1.DockerImageReference)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_image_DockerImageReference_To_v1_DockerImageReference(a.(*image.DockerImageReference), b.(*v1.DockerImageReference), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_DockerImageReference_To_image_DockerImageReference(in *v1.DockerImageReference, out *image.DockerImageReference, s conversion.Scope) error {
	// WARNING: in.Registry requires manual conversion: does not exist in peer-type
...
func autoConvert_image_DockerImageReference_To_v1_DockerImageReference(in *image.DockerImageReference, out *v1.DockerImageReference, s conversion.Scope) error {
	// FIXME: Type image.DockerImageReference is unsupported.
	return nil
}
...
func autoConvert_image_TagImportPolicy_To_v1_TagImportPolicy(in *image.TagImportPolicy, out *v1.TagImportPolicy, s conversion.Scope) error {
	out.Insecure = in.Insecure
	out.Scheduled = in.Scheduled
	out.ImportMode = v1.ImportModeType(in.ImportMode)
	return nil
}
