...
func init() {
	...
	addDeadClusterRoleBinding("system:openshift:controller:build-controller", "system:openshift:controller:build-controller")
	addDeadClusterRole("system:openshift:controller:build-config-change-controller")
	addDeadClusterRoleBinding("system:openshift:controller:build-config-change-controller", "system:openshift:controller:build-config-change-controller")
	addDeadClusterRole("system:openshift:controller:deployer-controller")
	...
	addDeadClusterRole("system:openshift:controller:template-instance-finalizer-controller")
	addDeadClusterRoleBinding("system:openshift:controller:template-instance-finalizer-controller", "system:openshift:controller:template-instance-finalizer-controller")
	addDeadClusterRoleBinding("system:openshift:controller:template-instance-finalizer-controller-admin", "admin")
	addDeadClusterRole("system:openshift:controller:origin-namespace")
	addDeadClusterRoleBinding("system:openshift:controller:origin-namespace", "system:openshift:controller:origin-namespace")
	addDeadClusterRole("system:openshift:controller:serviceaccount-pull-secrets-controller")
	addDeadClusterRoleBinding("system:openshift:controller:serviceaccount-pull-secrets-controller", "system:openshift:controller:serviceaccount-pull-secrets-controller")
	addDeadClusterRole("system:openshift:controller:image-trigger-controller")
	addDeadClusterRoleBinding("system:openshift:controller:image-trigger-controller", "system:openshift:controller:image-trigger-controller")
	addDeadClusterRole("system:openshift:controller:image-import-controller")
	addDeadClusterRoleBinding("system:openshift:controller:image-import-controller", "system:openshift:controller:image-import-controller")
	addDeadClusterRole("system:openshift:controller:unidling-controller")
