...
func printOAuthClient(oauthClient *oauthapi.OAuthClient, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printOAuthClientList(oauthClientList *oauthapi.OAuthClientList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printOAuthClientAuthorization(oauthClientAuthorization *oauthapi.OAuthClientAuthorization, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printOAuthClientAuthorizationList(oauthClientAuthorizationList *oauthapi.OAuthClientAuthorizationList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printOAuthAccessToken(oauthAccessToken *oauthapi.OAuthAccessToken, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printOAuthAccessTokenList(oauthAccessTokenList *oauthapi.OAuthAccessTokenList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
...
func printOAuthAuthorizeToken(oauthAuthorizeToken *oauthapi.OAuthAuthorizeToken, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
	row := metav1.TableRow{
...
func printOAuthAuthorizeTokenList(oauthAuthorizeTokenList *oauthapi.OAuthAuthorizeTokenList, options kprinters.PrintOptions) ([]metav1.TableRow, error) {
