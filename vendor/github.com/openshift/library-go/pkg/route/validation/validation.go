...
// Any changes made to this regex must be reflected in openshift/api(https://github.com/openshift/api/blob/master/route/v1/types.go & https://github.com/openshift/api/blob/master/operator/v1/types_ingress.go) for Route.spec.httpHeaders.actions[*].response, Route.spec.httpHeaders.actions[*].request, IngressController.spec.httpHeaders.actions[*].response, and IngressController.spec.httpHeaders.actions[*].request of the Route API for the benefit of client-side validation.
var (
