...
var map_MaxAgePolicy = map[string]string{
	...
	"largestMaxAge":  "The largest allowed value (in seconds) of the RequiredHSTSPolicy max-age This is a pointer to distinguish between value of zero and value unspecified. kubebuilder:validation:minimum=0:maximum=2147483647",
	"smallestMaxAge": "The smallest allowed value (in seconds) of the RequiredHSTSPolicy max-age Setting max-age=0 allows the deletion of an existing HSTS header from a host.  This is a necessary tool for administrators to quickly correct mistakes. This is a pointer to distinguish between value of zero and value unspecified. kubebuilder:validation:minimum=0:maximum=2147483647",
}
