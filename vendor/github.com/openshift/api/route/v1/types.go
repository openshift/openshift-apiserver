...
type RouteSpec struct {
	...
	// httpSetHeaders defines HTTP headers that should be set/append.
	...
	// +optional
	HTTPSetHeaders RouteSetHTTPHeaders `json:"httpSetHeaders,omitempty" protobuf:"bytes,9,opt,name=httpSetHeaders"`
	...
	// +kubebuilder:validation:Optional
	// +optional
	HTTPDeleteHeaders RouteDeleteHTTPHeaders `json:"httpDeleteHeaders,omitempty" protobuf:"bytes,10,opt,name=httpDeleteHeaders"`
}
