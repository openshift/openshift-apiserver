...
var map_RouteHeadersManipulation = map[string]string{
...
func (RouteHeadersManipulation) SwaggerDoc() map[string]string {
	return map_RouteHeadersManipulation
}
