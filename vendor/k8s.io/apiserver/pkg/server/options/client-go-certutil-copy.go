...
// with the one present in the v0.27.7 client-go source[1] is
// the modification to change the maxAge variable to ~3 years.
//
// [1]: https://github.com/kubernetes/client-go/blob/bec45d3c69b597c35e0246cce5c5001127edf994/util/cert/cert.go#L93C1-L230C2
