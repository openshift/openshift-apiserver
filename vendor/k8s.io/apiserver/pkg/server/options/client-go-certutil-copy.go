...
// with the one present in the v0.28.3 client-go source[1] is
// the modification to change the maxAge variable to ~3 years.
//
// [1]: https://github.com/kubernetes/client-go/blob/9d454d6c3adfb3beb32b38eb692c1688df56c0ec/util/cert/cert.go#L93-L230
